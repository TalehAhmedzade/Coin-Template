...
//detail sehifesi yenilendikde gelmesi ucun axirda ele

// export const getDetailByName =  createAsyncThunk(`getDetailByName`, async (name) => {
...
//     console.log(request);
//     const response = await axios.get(
//       `http://localhost:4000/?country=${request.country}&metal=${
//         request.metal
//       }&quality=${request.quality}&price-from=${+request.price
//         .from}&price-to=${+request.price.to}&year-from=${+request.year
//         .from}&year-to=${+request.year.to}`
//     );
//     console.log(response.data);
//   }
// )
// export const deleteCoinByName = createAsyncThunk(`delete`,
//   async(name)=>{
//     const response = await axios.get(`http://localhost:4000/delete/'${name}'`);
//     console.log(response.data);
//     return response.data
//   }
// )
...
//   async (request) => {
//     console.log(request)
//     const response = await axios.put(`https://localhost:4000/coins/${request.coinId}`, request)
//     return response.data;
//   }
// );
